...
Consequently, neither LiH nor MgO is eligible for a final g-xTB LC12 lattice constant or cohesive energy in the frozen campaign. The remaining ten solids retain the provisional lattice-constant MAE of `0.16713620093` angstrom, compared with `0.145117815` angstrom for GFN1-xTB and `0.06240968` angstrom for GFN2-xTB on the same common ten systems. No g-xTB LC12 cohesive-energy MAE is reported.
