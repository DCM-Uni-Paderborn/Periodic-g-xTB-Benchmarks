...
|---|---|---|
| `auto_policy_regression_20260722/` | Final public-source, exact-binary focused CP2K regression: 48 normally terminated calculations and 196/196 matcher results; implicit/explicit AUTO, dense one-point ACP, streamed/sparse multi-point ACP, symmetry-fused/mixed-radix selection, molecular CLI controls, derivatives, and restarts | Correctness and production-policy provenance only; the run is not used for timing, memory, or scaling claims |
