#!/usr/bin/env python3
"""Run a fixed DENSE/KGROUP_PARTIAL_ROOT CP2K oracle matrix.
...
def main() -> int:
    ...
    parser.add_argument("--variant", choices=("DENSE", "PARTIAL_ROOT", "BOTH"), default="BOTH")
    ...
    variants = ("DENSE", "PARTIAL_ROOT") if args.variant == "BOTH" else (args.variant,)
